...
class Get5gNrModeUseCase: SuspendingUseCase<Get5gNrModeUseCase.Params, LteNrModeState>() {
    ...
    override suspend fun execute(params: Params): ApiResult<LteNrModeState> {
