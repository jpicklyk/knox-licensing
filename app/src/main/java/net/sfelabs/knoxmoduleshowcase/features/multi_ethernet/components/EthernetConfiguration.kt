...
import net.sfelabs.knoxmoduleshowcase.features.multi_ethernet.EthernetConfigurationEvents
...
fun EthernetConfiguration(
    ...
    OutlinedCard(
        ...
        StaticIPFieldsComponent(
            ...
            onIpAddressChanged = { viewModel.onEthernetConfigurationEvent(
                EthernetConfigurationEvents.EnteredIpAddress(it)) },
