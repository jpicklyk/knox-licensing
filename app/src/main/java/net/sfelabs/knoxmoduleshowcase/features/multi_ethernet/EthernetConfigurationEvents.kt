...
sealed class EthernetConfigurationEvents {
    data object EnableEthernetAutoConnection: EthernetConfigurationEvents()
    data object DisableEthernetAutoConnection: EthernetConfigurationEvents()
    ...
    data object SaveConfiguration: EthernetConfigurationEvents()
}
