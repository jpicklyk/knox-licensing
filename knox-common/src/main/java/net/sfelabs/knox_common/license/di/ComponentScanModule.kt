package net.sfelabs.knox_common.license.di
...
import net.sfelabs.knox_common.license.data.LicenseRepositoryImpl
import net.sfelabs.knox_common.license.domain.usecase.GetLicenseInfoUseCase
import net.sfelabs.knox_common.license.domain.usecase.GetLicenseInfoUseCaseImpl
import net.sfelabs.knox_common.license.domain.usecase.KnoxLicenseUseCase
import net.sfelabs.knox_common.license.domain.usecase.KnoxLicenseUseCaseImpl
